...
#define VOB_AOERN_INIT_GRAPHIC_OBJECT_ID = 0
#else
#define INIT_GRAPHIC_OBJECT 
#define VOB_AOERN_INIT_GRAPHIC_OBJECT_ID
#endif

namespace vob::aoegl
{
	using graphic_object_id = GLuint;
	using graphic_index = GLuint;
	using graphic_size_int = GLsizei;
