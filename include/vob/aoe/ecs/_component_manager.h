...
namespace vob::_aoecs
{
	...
	public:
		...
		void add(basic_component_holder_clone a_componentHolderClone)
		{
		...
		auto const& get_components() const
		{
			return m_components;
		}
        ...
        bool accept(VisitorType& a_visitor)
        {
            a_visitor.visit(misvi::ctn(
                m_components
                , _aoecs::component_holder_clone_factory{ m_cloner }
            ));
			return true;
        }
