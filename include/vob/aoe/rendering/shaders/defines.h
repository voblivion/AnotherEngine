...
#define SPOT_LIGHT_SHADOW_MAPS_CAPACITY 12
...
#define BINDING_TEXTURE_TONEMAP_SOURCE 0

#define BINDING_TEXTURE_ANTI_ALIASING_SOURCE 0

#define BINDING_TEXTURE_PRESENT_SOURCE 0

#define BINDING_TEXTURE_DEBUG_SOURCE 0
...
struct ALIGN_16 UniformDebugParams
{
	...
	static constexpr uint32_t k_bindingTextureTonemapSource = BINDING_TEXTURE_TONEMAP_SOURCE;

	static constexpr uint32_t k_bindingTextureAntiAliasingSource = BINDING_TEXTURE_ANTI_ALIASING_SOURCE;

	static constexpr uint32_t k_bindingTexturePresentSource = BINDING_TEXTURE_PRESENT_SOURCE;

	static constexpr uint32_t k_bindingTextureDebugSource = BINDING_TEXTURE_DEBUG_SOURCE;
...
#undef SUN_CASCADING_SHADOW_MAPS_CAPACITY
...
#undef BINDING_TEXTURE_TONEMAP_SOURCE
#undef BINDING_TEXTURE_ANTI_ALIASING_SOURCE
#undef BINDING_TEXTURE_PRESENT_SOURCE
#undef BINDING_TEXTURE_DEBUG_SOURCE

#undef DEBUG_TYPE_COLOR_TEXTURE
#undef DEBUG_TYPE_SHADES_TEXTURE
#undef DEBUG_TYPE_DEPTH_TEXTURE
#undef DEBUG_TYPE_DIRECTION_TEXTURE
#undef DEBUG_TYPE_LIGHT_CLUSTERS
