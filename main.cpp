...
void init_default_map(aoeng::world& a_world, aoe::DataHolder& a_data)
{
	...
	{
		auto const debugCameraId = entityRegistry.create();
		entityRegistry.emplace<vob::aoedb::debug_controller_component>(debugCameraId, *debugCameraArk->find<vob::aoedb::debug_controller_component>());
		entityRegistry.emplace<vob::aoest::transform_component>(debugCameraId, *debugCameraArk->find<vob::aoest::transform_component>());
		entityRegistry.emplace<vob::aoegl::camera_component>(debugCameraId, *debugCameraArk->find<vob::aoegl::camera_component>());
	}
}
